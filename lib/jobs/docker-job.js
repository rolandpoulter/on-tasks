...
dockerJobFactory.$provide = 'Job.Docker';
dockerJobFactory.$inject = [
    'Job.Base',
    'Util',
    'Logger',
    'Assert',
            ...
            function dockerCall(call) {
                return new Promise(function (resolve, reject) {
                    ...
                    args.push(function(err) {
                        ...
                        if (call.store) {
                            Object.keys(call.store).forEach(function (prop) {
                                self.context[prop] = args[call.store[prop]];
                            });
                        }
                            ...
                            return finishDockerCall(
                                Object.keys(call.emit).map(function (routingKey) {
                                    ...
                                    if (typeof obj.ref === 'number') {
                                      obj.value = args[obj.ref] || obj.value;
                                    }
                    ...
                    if (typeof args[0] === 'string' && args[0].charAt(0) === '$') {
                        ...
                        console.log('====FIX====', args[0], containerNode.docker);
                    }
